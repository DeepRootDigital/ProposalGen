<div class="viewport">
    <div class="container">
        <div class="content-slide">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/slide-images/paul.png">
            ...
            <div class="team-member">
                <img src="<?php echo get_template_directory_uri(); ?>/images/slide-images/diane.png">
                <div class="team-wrapper">
                    <h3>Diane Kretschmer<span>// Copywriter</span></h3>
                    <p>Diane has been involved in the direct marketing industry for more than 30 years in management positions with a variety of firms and nonprofits both on and offline. Her background includes marketing strategy, advertising, planning, e-marketing, e-commerce, lead generation, product introductions and, of course, copywriting. Diane holds a BA in English and an MBA in Marketing and writes from her home in San Francisco. She’s thrilled to be working with the accomplished Business on Market St. team.</p>
                </div>
            </div>
